...
/* --------- Set up interrupt configuration for D+ (CPU specific) ------------  */

/* == NOTE: This section is copied from the micronucleus config t85_default. == */
 ...
 */
#define USB_CFG_VENDOR_NAME     'A', 'n', 't', 'o', 'n', ' ', 'S', 'e', 'm', 'j', 'o', 'n', 'o', 'v'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'u', 's', 'b', 'p', 'i', 'x', 'e', 'l'
